<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CollectionForMonth.aspx.cs" Inherits="WebSite5_production_Interest_Waiver" %>
                                       ...
                                       <div class="container-fluid">
                                           ...
                                           <div class="row">
                                               ...
                                               <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                                   <br />
                                                   <h3 class="text-center">COLLECTION FOR MONTH </h3>
                                               </div>
                                           </div>
                                       </div>
                                       <br />
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="">
                                              <div class="form-group">
                                                  ...
                                                  <select class="form-control" name="type" runat="server" id="type" >
                                                      ...
                                                      <option value="0">With Rows</option>
                                                       <option value="1">Without Rows</option>
