<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Closed_Loans.aspx.cs" Inherits="WebSite5_production_Closed_Loans" %>
                                       ...
                                       <div class="container-fluid">
                                           ...
                                           <div class="row">
                                               ...
                                               <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                                   <br />
                                                   <h3 class="text-center">INTEREST LOSS - CLOSED LOANS</h3>
                                               </div>
                                           </div>
                                       </div>
                                       <br />
                                       <div class="container-fluid">
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="row">
                                             ...
                                             <div class="row">
                                               <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="">
                                                   <label for="sel1">Up To Date:</label>
