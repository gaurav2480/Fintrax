<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TallySyncMrktg_Pay_Sales_O - Copy.aspx.cs" Inherits="WebSite5_production_TallySyncMrktg_Pay_Sales_O" %>
      ...
      <script>
        ...
        $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'TallySyncMrktg_Pay_Sales_O.aspx/data',
