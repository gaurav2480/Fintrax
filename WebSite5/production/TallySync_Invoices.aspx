<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TallySync_Invoices.aspx.cs" Inherits="WebSite5_production_TallySync_Invoices" %>
                                  ...
                                  <div class="container-fluid">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                              <br />
                                              <h3 class="text-center">INVOICES CREATION IN TALLY</h3>
                                          </div>
                                      </div>
                                  </div>
                                  <br />
      ...
      <script>
        ...
        $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'TallySync_Invoices.aspx/data',
                    ...
                    success: function (data) {
                        ...
                        $("#type").empty();
                        $("#type").append("<option disabled selected value>Select an Option</option>");
                        ...
                        $.each(subJson, function (key, value) {
                            ...
                            $.each(value, function (index1, value1) {
                                ...
                                if (value1[0] == "") {
                                    ...
                                    $("#type").append("<option value='" + value1[0] + "'>" + value1[0] + "</option>");
                                }
                            });
