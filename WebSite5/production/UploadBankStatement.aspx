<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadBankStatement.aspx.cs" Inherits="WebSite5_production_UploadBankStatement" %>
                                  ...
                                  <div class="container-fluid">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                              <br />
                                              <h3 class="text-center">UPLOAD OTHER RECEIPTS</h3>
                                          </div>
                                      </div>
                                  </div>
                                  <br />
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <select class="form-control" name="bank" runat="server" id="bank" >
                                                      <option disabled selected value>Select an Option</option>
                                                       <option value="5">ICICI BANK A/c No.002305000542</option>
                                                       <option value="20090">HDFC Bank Ltd</option>
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="">
                                              <div class="form-group">
                                                  ...
                                                  <select class="form-control" name="statementType" runat="server" id="statementType" >
                                                      <option disabled selected value>Select an Option</option>
                                                       <option value="4023">Unidentified</option>
                                                       <option value="28672">Payzapp Account</option>
