<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoanRepaymentSchedule.aspx.cs" Inherits="WebSite5_production_LoanRepaymentSchedule" %>
                                      ...
                                      <div class="row">
                                          <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="">
                                              <label for="sel1">LOAN NO:</label>
                                                  ...
                                                  <asp:TextBox ID="loanNo" class="form-control pull-right" runat="server"></asp:TextBox>
