<%@ Page Language="C#" AutoEventWireup="true" CodeFile="previousCurrentSchedule.aspx.cs" Inherits="WebSite5_production_previousCurrentSchedule" %>
                               ...
                               <div class="x_panel">
                                   ...
                                   <div class="x_content" id="x_content">
                                       <div class="container-fluid">
                                           ...
                                           <div class="row">
                                               ...
                                               <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                                   <br />
                                                   <h3 class="text-center">INTEREST LOSS </h3>
                                               </div>
                                           </div>
                                       </div>
                                       <br />
                                       <div class="container-fluid">
                                           ...
                                           <rsweb:reportviewer id="ReportViewer1" runat="server" height="400px" width="600" AsyncRendering="False"></rsweb:reportviewer>
