<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cybil.aspx.cs" Inherits="WebSite5_production_cybil" %>
...
.has-search .form-control {
    ...
    <script src="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js"></script>
      ...
      <script type="text/javascript">
        function redirect() {
            window.location.href = "searchLoan.aspx";
...
<body class="nav-md">
 ...
 <li><a href="ClientRegister.aspx">Client Register</a></li>                              </ul>
                          </li>
                              ...
                              <div class="x_panel">
                                  ...
                                  <div class="x_content" id="x_content">
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-2 col-sm-2 col-xs-12 col-lg-2" id="custGender">
                                                  <div class="form-group">
                                                      ...
                                                      <asp:DropDownList ID="gender" class="form-control pull-right" runat="server">
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-2 col-xs-12 col-sm-2 col-lg-2" id="currNewMemberName">
                                                  <div class="form-group">
                                                      ...
                                                      <asp:TextBox ID="currentNewMemberName" class="form-control pull-right" placeholder="" value="Parshuram Finance Pvt. Ltd." runat="server"></asp:TextBox>
                                                  </div>
                                              </div>
                                      ...
                                      <div class="container-fluid">
                                          ...
                                          <div class="row">
                                                <div class="col-md-2 col-xs-12 col-sm-2 col-lg-2" id="">
                                                 ...
                                                 <div class="col-md-2 col-xs-12 col-sm-2 col-lg-2" id="">
                                                  ...
                                                  <div class="input-group date" id="datepicker11" data-provide="datepicker1">
                                          ...
                                          <div class="col-md-2 col-xs-12 col-sm-8 col-lg-2">
                                              <div class="form-group">
                                                  <asp:Button ID="Button1" class="btn btn-success" runat="server" OnClick="Button1_Click" Text="Insert" />
                                              </div>
                                          </div>
