<%@ Page Language="C#" AutoEventWireup="true" CodeFile="searchLoanEdit.aspx.cs" Inherits="WebSite5_production_searchLoanEdit" %>
        ...
        $(document).ready(function () {
            ...
            $("#TextBox1").keyup(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'searchLoanEdit.aspx/searchProfile',
                        ...
                        $.each(subJson, function (key, value) {
                            ...
                            $.each(value, function (index1, value1) {
                                ...
                                if (value1[0] == "") {
                                    ...
                                    $("#task-table2 tbody").append("<tr><td><a href='" + value1[0] + "' id='profileclick'>" + value1[0] + "</a></td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td></tr>");
                                }
                            });
                ...
                $(document).ready(function () {
                    ...
                    $(document).on('click', '#profileclick', function () {
                        ...
                        $.ajax({
                            ...
                            type: 'Post',
                            url: 'searchLoanEdit.aspx/getlink',
                            contentType: "application/json; charset=utf-8",
                            data: "{'loanNo':'" + loanNo + "'}",
                            async: false,
                            success: function (data) {
