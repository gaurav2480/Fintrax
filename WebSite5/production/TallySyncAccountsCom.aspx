<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TallySyncAccountsCom.aspx.cs" Inherits="WebSite5_production_TallySyncAccountsCom" %>
                        ...
                        <div class="menu_section">
                          ...
                          <li><a><i class='fa fa-home'></i>Tally Sync<span class='fa fa-chevron-down'></span> </a>
                              <ul class='nav child_menu'>
                                  <li><a href="TallySyncAccountsCom.aspx">Sync Purchase Vouchers</a></li>
                                  ...
                                  <div class="container-fluid">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                              <br />
                                              <h3 class="text-center">CREATION IN TALLY</h3>
                                          </div>
                                      </div>
                                  </div>
                                  <br />
                                      ...
                                      <div>
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="">
                                              <div class="form-group">
                                                  ...
                                                  <select class="form-control" name="type" runat="server" id="type" >
                                                      <option disabled selected value>Select an Option</option>
                                                       <option value="COM FIXED">COM FIXED</option>
                                                       <option value="COM BONUS">COM BONUS</option>
                                                       <option value="SPIFF/BONUS">SPIFF/BONUS</option>
                                          ...
                                          <div class="row">
                                              <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="">
                                                  <div class="form-group">
                                                      <label for="sel1">Type:</label>
                                                      <select class="form-control" name="typeValue" runat="server" id="typeValue">
                                                      </select>
                                                  </div>
                                              </div>
      ...
      <script>
        ...
        $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    type: 'Post',
                    url: 'TallySyncAccountsCom.aspx/data',
                    ...
                    success: function (data) {
                        ...
                        $("#typeValue").empty();
                        $("#typeValue").append("<option disabled selected value>Select an Option</option>");
                        ...
                        $.each(subJson, function (key, value) {
                            ...
                            $.each(value, function (index1, value1) {
                                ...
                                if (value1[0] == "") {
                                    ...
                                    $("#typeValue").append("<option value='" + value1[0] + "'>" + value1[0] + "</option>");
                                }
                            });
