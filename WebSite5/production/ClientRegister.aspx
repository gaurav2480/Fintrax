<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientRegister.aspx.cs" Inherits="WebSite5_production_ClientRegister" %>
                          ...
                          <li><a><i class='fa fa-home'></i>Cybil<span class='fa fa-chevron-down'></span> </a>
                           ...
                           <li><a><i class='fa fa-home'></i>Reports<span class='fa fa-chevron-down'></span> </a>
                              <ul class='nav child_menu'>
                                  ...
                                  <li><a href="ClientRgister.aspx">Client Register</a></li>
                              </ul>
                          </li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="">
                                              <div class="form-group">
                                                  <label for="sel1">US$ RATE:</label>
                                                <asp:TextBox runat="server" ID="US" class="form-control"></asp:TextBox>
                                              </div>
                                          </div>
