<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TallySyncPA_NO.aspx.cs" Inherits="WebSite5_production_TallySyncPA_NO" %>
                                  ...
                                  <div class="container-fluid">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                              <br />
                                              <h3 class="text-center">PA NO LEGDER CREATION IN TALLY</h3>
                                          </div>
                                      </div>
                                  </div>
                                  <br />
