...
public partial class WebSite5_production_TallySyncMrktg_Pay_Sales_O_CC_Avenue : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string selectDataQuery = "select Transaction_ID,Amount,Date ,* from TallySyncAcc_Mrktg_Pay_Sales_O where status='Active' and Card_Type='CC_Avenue'  and convert(varchar(10) ,convert(datetime,date,103),105) ='" + Dates+"'";
            SqlCommand cmd2 = new SqlCommand(selectDataQuery, sqlcon1);
            SqlDataReader reader1 = cmd2.ExecuteReader();
            while (reader1.Read())
            {
                string result = "";
                string Transaction_ID = reader1.GetString(0);
             ...
             //   HttpWebRequest httpWebRequest1 = (HttpWebRequest)WebRequest.Create("http://192.168.0.9:" + "9029");
                ...
                {
                    string query1 = "update TallySyncAcc_Mrktg_Pay_Sales_O set status='Inactive' where Transaction_ID='" + Transaction_ID + "' and Card_Type='CC_Avenue' and Amount='" + Amount + "'";
            ...
            Response.AppendHeader("Refresh", "03;url=TallySyncMrktg_Pay_Sales_O_CC_Avenue.aspx");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.PostedFile != null)
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                string selectQuery = "select * from TallySyncAcc_Mrktg_Pay_Sales_O where Transaction_ID='" + row["CCAvenue Ref#"] + "' and Amount='"+row["Gross Amount"]+"'";
