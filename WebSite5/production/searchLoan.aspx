<%@ Page Language="C#" AutoEventWireup="true" CodeFile="searchLoan.aspx.cs" Inherits="WebSite5_production_searchLoan" %>
      ...
      font-style:oblique;
        ...
        #img {
         ...
         #update,#directory,#insert,#menu_toggle,#task-table2{
           ...
           #success-alert,#danger-alert,#danger-alert1,#warning-alert{
            display:none;
        }
           #TextBox5{
               text-align:center;
              ...
              <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                 <div id="addEmployeeModal" class="modal fade">
                    ...
                    <div class="alert alert-warning" id="warning-alert">
                        <button type="button" class="close" data-dismiss="alert">x</button>
                        <strong>Data already inserted fo this loan no.!! </strong>
    ...
    <script src="../build/js/custom.min.js"></script>
        ...
        $(document).ready(function () {
            ...
            $("#TextBox1").keyup(function () {
                ...
                var loanNo = $("#TextBox1").val();

                $.ajax({

                    type: 'Post',
                    url: 'searchLoan.aspx/searchProfile',
                        ...
                        $.each(subJson, function (key, value) {
                            ...
                            $.each(value, function (index1, value1) {
                                ...
                                if (value1[0] == "") {
                                    ...
                                    $("#warning-alert").fadeTo(1500, 900).slideUp(900, function () {
                                        $("#warning-alert").slideUp(900);
                                    });
                                    $("#task-table2").hide();
                                } else {

                                    //$("#task-table2 tbody").append("<tr><td><a href='" + value1[1] + "'>" + value1[0] + "</a></td></tr>");
                                    $("#task-table2 tbody").append("<tr><td><a href='" + value1[0] + "' id='profileclick'>" + value1[0] + "</a></td><td>" + value1[1] + "</td><td>" + value1[2] + "</td><td>" + value1[3] + "</td><td>" + value1[4] + "</td></tr>");
                                }
                            });
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    $(document).on('click', '#profileclick', function () {
                        ...
                        var loanNo = row.find("td:eq(0)").text();
                        $.ajax({

                            type: 'Post',
                            url: 'searchLoan.aspx/getlink',
                            contentType: "application/json; charset=utf-8",
                            data: "{'loanNo':'" + loanNo + "'}",
                            async: false,
                            success: function (data) {
