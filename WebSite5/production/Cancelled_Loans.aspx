<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cancelled_Loans.aspx.cs" Inherits="WebSite5_production_Cancelled_Loans" %>
                              ...
                              <div class="x_content" id="x_content">
                                  ...
                                  <div class="container-fluid">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 " id="head">
                                              <br />
                                              <h3 class="text-center">INTEREST LOSS - CANCELLED LOANS</h3>
                                          </div>
                                      </div>
                                  </div>
                                  <br />
                                  <div class="container-fluid">
                                      ...
                                      <div class="row">
                                       ...
                                       <div class="row">
                                          <div class="col-md-3 col-xs-12 col-sm-3 col-lg-3" id="">
                                              <label for="sel1">UPTO Date:</label>
                                              <div class="input-group date" id="datepicker3" data-provide="datepicker">
                                                  <asp:TextBox ID="UPTODATE" class="form-control pull-right" runat="server"></asp:TextBox>
                                                  <div class="input-group-addon">
                                                      <span class="glyphicon glyphicon-th"></span>
                                                  </div>
                                              </div>
     ...
     <div class="row">
                                          <div class="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="">
                                              <div class="form-group">
                                                  <label for="sel1">Disbursment Status:</label>
                                                  <select class="form-control" name="disbursmentStatus">
